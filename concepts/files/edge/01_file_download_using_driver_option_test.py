...
class TestFileDownloadUsingDriverOption(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        # Creating Edge options for customizing the behavior of the Edge WebDriver
        edge_options = webdriver.EdgeOptions()

        # Setting preferences for the Edge WebDriver
        ...
        # Adding the preferences to the experimental options of the Edge WebDriver
    ...
    def test_file_download_using_driver_option(self):
        ...
        # Wait for 15 seconds for file to download (Edge is not working properly)
        time.sleep(15)
