...
class TestKeyDown(unittest.TestCase):
    ...
    def test_key_down(self):
        ...
        # Simulate the key-down action by holding the SHIFT key, typing "app"
        self.actions.key_down(Keys.SHIFT).send_keys("app").perform()
        ...
        # Assert that the input element's value is equal to "APP"
        self.assertEqual(input_element_value, "APP")
