...
class TestMouseForwardClick(unittest.TestCase):
    ...
    def test_mouse_forward_click(self):
        ...
        # Perform a mouse button down action on the FORWARD button
        self.action_builder.pointer_action.pointer_down(MouseButton.FORWARD)

        # Perform a mouse button up action on the FORWARD button
        self.action_builder.pointer_action.pointer_up(MouseButton.FORWARD)
