...
class TestScrollFromElementByGivenAmount(unittest.TestCase):
    ...
    def test_scroll_from_element_by_given_amount(self):
        ...
        # Determine the scroll origin based on the element
        self.scroll_origin = ScrollOrigin.from_element(selenium_donation_element)
